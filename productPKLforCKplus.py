...
'''
----------------------------------------------------------------
Generate the pre-processed data of CK+
DGFN, DFSN, DFSN-I: 
...
imgPath = './Data-Experiment/data_ck+/CK+_Ten_group.txt'

#change to your data root according the image path from txt file
data_root_path = 'E:/Ty/cohn-kanade-images/'
    ...
    for j,v in enumerate(imagelist):
        ...
        for k,m in enumerate(v):
            ...
            if imgr[1]:
                ...
                cv2.imwrite('./Data-Experiment/face_from_ck+/'+str(gc)+'.jpg',img2)
...
filenametosave='./Data-Experiment/data_ck+/ckplus_with_img_geometry_3frame.pkl'
